...
namespace BlockchainAssignment
{
    class Blockchain
    {
        ...
        // Finds 5 transactions from transaction pool to use in next block
        ...
        // Compares block's merkle root with calculated merkle root to ensure validity
